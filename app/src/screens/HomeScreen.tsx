...
const styles = StyleSheet.create({
  ...
  headerTopRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 28, justifyContent: 'space-between' },
  headerLeft: { flexDirection: 'row', alignItems: 'center', flex: 1, paddingRight: 10 },
  logoCircle: { width: 56, height: 56, backgroundColor: '#fff', borderRadius: 28, justifyContent: 'center', alignItems: 'center', elevation: 5, overflow: 'hidden', borderWidth: 1.5, borderColor: '#fff' },
  logoImg: { width: 56, height: 56, borderRadius: 28 },
  titleCol: { marginLeft: 14, flex: 1 },
  hdTitle: { color: '#FCD34D', fontSize: 19, fontWeight: '700', letterSpacing: 0.2 },
  hdSub: { color: '#aac4e8', fontSize: 11, marginTop: 4, fontWeight: '500' },
  ...
  notifBadge: { position: 'absolute', top: 4, right: 6, width: 9, height: 9, backgroundColor: '#ef4444', borderRadius: 4.5, borderWidth: 1.5, borderColor: '#1a2d5a' },
  avatarWrapper: { width: 46, height: 46, position: 'relative' },
  avatarImg: { width: 46, height: 46, borderRadius: 23, borderWidth: 2, borderColor: '#FCD34D' },
  avatarPlaceholder: { width: 46, height: 46, borderRadius: 23, backgroundColor: '#1e293b', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#FCD34D' },
  avatarLetter: { color: '#FCD34D', fontWeight: '800', fontSize: 16 },
  onlineBadge: { position: 'absolute', bottom: -2, right: -2, width: 14, height: 14, borderRadius: 7, backgroundColor: '#22c55e', borderWidth: 2, borderColor: '#1a2d5a' },
  
  greetingSection: { marginTop: 4 },
  greetingText: { color: '#fff', fontSize: 20, fontWeight: '700', marginBottom: 6 },
  userNameGold: { color: '#FCD34D', fontWeight: '700' },
  dateText: { color: '#aac4e8', fontSize: 13, fontWeight: '500' },
