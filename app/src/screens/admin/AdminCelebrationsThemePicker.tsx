...
export default function AdminCelebrationsThemePicker({ onBack, onSelectTheme, onDeleteSuccess }: { onBack: () => void, onSelectTheme: (themeId: string) => void, onDeleteSuccess?: () => void }) {
