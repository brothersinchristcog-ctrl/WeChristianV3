...
export default function AdminWeCelebrationsVersePicker({ category, selectedVerseRef, onBack, onSelectVerse }: { category: string, selectedVerseRef?: string, onBack: () => void, onSelectVerse: (verse: {ref: string, text: string}) => void }) {
